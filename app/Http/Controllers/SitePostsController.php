...
class SitePostsController extends Controller
{
    ...
    public function store(Request $request,Posts $posts)
    {
        ...
        if ($request['gender'] != 'autre') {
            if ($request['tags'] == "") {
                $request['tags'] = $request['gender'];
            }else{
                $request['tags'] = $request['tags'] . ',' . $request['gender'];
            }
        }

        if ($request['other_tag'] != 'autre') {
            if ($request['tags'] == "") {
                $request['tags'] = $request['other_tag'];
            }else{
                $request['tags'] = $request['tags'] . ',' . $request['other_tag'];
            }
        }
        
        unset($request['other_tag']);
